        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {[
              ...
              >
                <Link to={tool.to} className="block h-full">
                  {/* Icon Section */}
                  <div
                    className={`relative h-32 bg-gradient-to-br ${tool.color} flex items-center justify-center`}
                  >
          ...
          <div className="text-center mt-12">
            <p className="text-gray-600 mb-6">
              Need help with probate real estate? Our experts are here to
              assist.
            </p>
            <Link
      ...
      <div className="-mt-14 " id="services">
        ...
        <section className="text-center container mx-auto p-4 staggered-fade-in">
          ...
          <p className="text-lg text-justify font-bold ">
            If you&apos;ve just been put in charge of selling a loved one&apos;s
            property and you&apos;re not sure where to start, you&apos;re
            exactly where you need to be.
            <br />
            <br />
            I know how overwhelming this responsibility can feel, especially
            when you&apos;re still processing loss, managing paperwork, or
            trying to keep the peace among family members. My role is to remove
            the weight from your shoulders, protect the value of the estate, and
            guide you through the real estate process with clarity, compassion,
            and control.
            <br />
            <br />
            As a{" "}
