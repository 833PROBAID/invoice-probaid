...
const questions = [
	{
		...
		category: "vacancy",
		context: "Most carriers downgrade coverage after 30 days without occupancy notice.",
	},
	{
		id: "utilities",
		question: "Are utilities turned on?",
		category: "vacancy",
		context: "Climate control protects plumbing and electrical systems from loss.",
	},
	{
		id: "secure",
		question: "Are doors and windows secure?",
		category: "security",
		context: "Insurers expect documented security to mitigate vandalism exposure.",
	},
	{
		id: "yard",
	...
	},
	{
		...
		category: "vacancy",
		context: "If left pressurized, burst lines are frequently denied without inspections.",
	},
	{
		id: "locks",
		question: "Have locks been changed?",
		category: "security",
		context: "Changing locks establishes control over access logs post-transition.",
	},
];
					...
					<div className='flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4'>
						<div>
							...
							<p className='text-sm md:text-base text-white/90 mt-3 max-w-3xl'>
								Surface insurance blind spots before they expose the estate to coverage gaps or denied claims.
							</p>
						</div>
				...
				<div className='p-4 sm:p-6 space-y-8'>
					...
					<div>
						...
						<div className='space-y-6'>
							{questions.map((q, index) => (
								<div key={q.id} className='bg-gray-50 border border-gray-100 rounded-lg p-4 shadow-sm'>
									<div className='flex flex-col md:flex-row md:items-center md:justify-between gap-2'>
										<div>
											...
											<p className='text-xs text-gray-500 max-w-2xl'>{q.context}</p>
										</div>
					...
					{results && (
									...
									<div className='space-y-4 text-sm text-gray-700'>
										<div>
											...
											{results.highAlerts.length ? (
												...
												<p className='mt-2 text-gray-500'>No unresolved critical alerts.</p>
											)}
										</div>
										<div>
											...
											{results.watchItems.length ? (
												...
												<p className='mt-2 text-gray-500'>No watch items flagged.</p>
											)}
										</div>
										<div>
						...
						<p className='text-center text-xs text-gray-500 italic'>
								Disclaimer: This tool is for scenario planning. Always consult a licensed insurance professional before binding coverage.
							</p>
						</div>
					)}
				</div>
