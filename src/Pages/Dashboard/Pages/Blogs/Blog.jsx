...
const Blog = () => {
    ...
    const fetchBlog = async () => {
      try {
        ...
        if (snapshot.exists()) {
          ...
          setOutputHtml(blogData.summary);
          setEditorState(blogData.editorState || null);
        } else {
          Swal.fire({
            icon: "error",
            title: "Error",
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await update(ref(database, `blogsDev/${id}`), {
        ...blog,
        imageUrl,
        summary: outputHtml,
      ...
      Swal.fire({
        icon: "success",
        title: blog.status === "published" ? "Blog Published" : "Draft Saved",
        text:
        ...
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center space-y-4 md:space-y-0">
            <div>
              ...
              <p className="mt-1 text-base text-white">Update your content</p>
            </div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <select
                  ...
                  className="block w-full p-3 border-2 border-gray-300 dark:border-gray-700 focus:ring-colorTeal focus:border-colorTeal rounded-md text-base text-gray-900 dark:text-darkText dark:bg-gray-800 pointer-events-none"
                >
                    ...
                    <div className="flex">
                      <div className="relative flex-grow">
                        ...
                        <input
                          ...
                          className="block w-full pl-10 pr-12 py-3 border-2 border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-colorTeal focus:border-colorTeal transition duration-150 text-base text-gray-900 dark:text-darkText dark:bg-gray-800"
                        />
                      </div>
                    </div>
                  </div>
                ...
                <>
                  <div>
                    ...
                    <div className="relative rounded-md shadow-sm">
                      ...
                      <input
                        ...
                        className="block w-full pl-10 py-3 border-2 border-gray-300 dark:border-gray-700 focus:ring-colorTeal focus:border-colorTeal rounded-md text-base text-gray-900 dark:text-darkText dark:bg-gray-800"
                      />
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <div className="relative rounded-md shadow-sm">
                        ...
                        <input
                          ...
                          className="block w-full pl-10 py-3 pr-3 border-2 border-gray-300 dark:border-gray-700 focus:ring-colorTeal focus:border-colorTeal rounded-md text-base text-gray-900 dark:text-darkText dark:bg-gray-800"
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="mt-1 flex rounded-md shadow-sm">
                      <span className="inline-flex items-center px-4 rounded-l-md border-2 border-r-0 border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-600 dark:text-gray-300 text-base font-medium">
                        domain.com/blogs/
                      </span>
                      <div className="relative flex-1">
                        <input
                          name="customUrl"
                          value={blog?.customUrl || id}
                          disabled
                          className="focus:ring-colorTeal focus:border-colorTeal block w-full rounded-none rounded-r-md text-base py-3 border-2 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-darkText px-3 bg-gray-100 dark:bg-gray-800"
                        />
                      </div>
                    </div>
                    <div className="mt-2 flex items-start">
                      ...
                      <p className="ml-3 text-sm text-gray-700 dark:text-gray-300 font-medium">
                        Custom URL cannot be changed after creation.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl border-2 border-gray-200 dark:border-gray-700">
                      ...
                      {(previewUrl || blog?.imageUrl) && (
                        <div>
                          <button
                            ...
                            className="inline-flex items-center px-3 py-1 border border-transparent text-xs font-medium rounded text-red-700 dark:text-red-300 bg-red-100 dark:bg-red-800 hover:bg-red-200 dark:hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors duration-200"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                          ...
                          <button
                            onClick={() => {
                              navigator.clipboard.writeText(blog.imageUrl);
                              Swal.fire({
                                icon: "success",
                            ...
                            className="ml-2 inline-flex items-center px-3 py-1 border border-transparent text-xs font-medium rounded text-green-700 dark:text-green-300 bg-green-100 dark:bg-green-700 hover:bg-green-200 dark:hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors duration-200"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="h-4 w-4 mr-1"
                            ...
                            >
                              <path
                                ...
                                strokeLinejoin="round"
                                strokeWidth={2}
                                d="M3 10h18M3 14h18m-9 4h9m-9-8h9m-9-4h9m-9-4h9M3 6h18"
                              />
                            </svg>
                            Copy Image URL
                          </button>
                    ...
                    {previewUrl || blog?.imageUrl ? (
                      <div className="relative rounded-lg overflow-hidden shadow-md border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                        <img
                          src={previewUrl || blog?.imageUrl}
                          alt="Blog preview"
                      ...
                      <div
                        className="group relative border-2 border-dashed border-gray-400 dark:border-gray-600 rounded-lg p-12 text-center hover:border-colorTeal transition-colors duration-200 cursor-pointer"
                        onClick={() =>
                          document.getElementById("file-upload").click()
                        }
                      >
                        <div className="space-y-2">
                          <div className="mx-auto h-16 w-16 flex items-center justify-center rounded-full bg-gray-100 dark:bg-gray-700 group-hover:bg-teal-50 dark:group-hover:bg-gray-600 transition-colors duration-200">
                            <svg
                              className="h-10 w-10 text-gray-400 dark:text-gray-500 group-hover:text-colorTeal transition-colors duration-200"
                              stroke="currentColor"
                              fill="none"
                              viewBox="0 0 48 48"
                            >
                          ...
                          <div className="flex text-sm text-gray-700 dark:text-gray-300 justify-center">
                            <label
                              htmlFor="file-upload"
                      ...
                      <div className="flex items-center space-x-4">
                        <div className="flex items-center">
                          <input
                            ...
                            className="h-4 w-4 text-colorTeal focus:ring-colorTeal border-gray-300 dark:border-gray-600"
                          />
                          <label
                  ...
                  <div>
                    ...
                    <div className="mt-1 rounded-md shadow-md overflow-hidden border-2 border-gray-300 dark:border-gray-700">
                      <GrapesEditor
