	...
	return (
		<>
			...
			<div className='max-w-7xl mx-auto p-4'>
				...
				<p className='text-colorOrange font-bold text-xl mt-5'>
					When you work with <span className='text-colorTeal'>833PROBAID™</span>, you gain a team that understands the
					stakes, respects the process, and executes with excellence.
					<br />
					<br />
