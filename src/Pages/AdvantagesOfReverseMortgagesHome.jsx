    ...
    <>
      ...
      <div className="max-w-7xl mx-auto p-4">
        ...
        <p className="text-colorOrange font-bold text-xl mt-5">
          ...
          <br />
          If the property is not {formatText("++sold++")} or refinanced fast
          enough, the estate or trust risks losing the home through foreclosure,
          which can destroy the equity that heirs or the conservatee depend on.
        </p>
        <img
