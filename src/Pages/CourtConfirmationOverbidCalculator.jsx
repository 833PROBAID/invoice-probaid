          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div className="bg-white/15 rounded-lg px-5 py-4 text-center">
              ...
              <p className="text-xl font-semibold mt-1">
                Enter offer, down payment, and optional deposits to unlock
                analytics.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div>
                ...
                />
                {errors.offerPrice && (
                  <p className="text-[#FD7702] text-sm mt-1">
                    {errors.offerPrice}
                  </p>
                )}
              </div>
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-gray-50 p-6 rounded-lg border border-gray-100">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-gray-700 leading-relaxed text-sm sm:text-base">
                    <li>
                      Offer Price: {formatCurrency(results.breakdown.offer)}
                    </li>
                    <li>
                      Base Amount: {formatCurrency(results.breakdown.base)}
                    </li>
                    <li>
                      10% of first $10,000:{" "}
                      {formatCurrency(results.breakdown.firstTenK)}
                    </li>
                    <li>
                      5% of remaining balance:{" "}
                      {formatCurrency(results.breakdown.remaining)}
                    </li>
                  </ul>
                </div>
                <div className="bg-white p-6 rounded-lg border border-gray-100 shadow-sm">
                  ...
                  <ul className="space-y-2 text-sm text-gray-700">
                    <li>
                      <span className="font-semibold text-[#0097A7]">
                        Leverage Ratio:
                      </span>{" "}
                      {results.leverageRatio}% of offer already funded.
                    </li>
                    <li>
                      <span className="font-semibold text-[#FD7702]">
                        Premium Delta:
                      </span>{" "}
                      Court requires {formatCurrency(results.premium)} above the
                      offer to open bidding.
                    </li>
                    <li>
                      <span className="font-semibold text-[#007A87]">
                        Cashier&apos;s Check Plan:
                      </span>{" "}
                      Prepare {formatCurrency(results.cashierCheck)} by day of
                      hearing.
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-blue-50 p-6 rounded-lg border border-blue-100">
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  For an offer of {formatCurrency(results.breakdown.offer)} with
                  a down payment of {formatCurrency(parseFloat(downPayment))},
                  the statutory minimum overbid equals{" "}
                  {formatCurrency(results.minOverbid)}. The court expects
                  cashier&apos;s check funds of
                  {formatCurrency(results.cashierCheck)} after crediting your
                  down payment. Keep proof of funds and cashier&apos;s check
                  receipts handy for the confirmation hearing.
                </p>
              </div>
              ...
              <p className="text-center text-xs text-gray-500 italic bg-yellow-50 p-4 rounded-lg">
                Disclaimer: Confirm all figures with your attorney or probate
                referee before court submission.
              </p>
            </div>
          )}
        </div>
